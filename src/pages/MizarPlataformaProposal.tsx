...
const META = {
  ...
  fecha: 'Agosto 2026',
  lugar: 'Colombia',
  objetivo: 'Plataforma de Requisiciones y Pagos de Obra: sistema a la medida que digitaliza el ciclo completo de requisiciones y pagos de obra: desde la solicitud hasta el gasto organizado por obra y listo para Contabilidad, evitando transcripciones manuales.',
...
const MODULOS: { num: string; nombre: string; icon: React.ElementType; color: string; colorAlpha: string; colorBorder: string; descripcion: string; items: string[] }[] = [
  ...
  },
  {
    ...
    descripcion: 'El corazón del sistema. Al aprobar, la requisición se parte automáticamente en tantas Órdenes de Compra como proveedores distintos tengan sus ítems.',
    items: [
      'Generación automática de una Orden de Compra por cada proveedor presente en la requisición',
  ...
  },
  {
    ...
    items: [
      ...
      'Nuevas obras, etiquetas y aprobadores se cargan como parte del servicio mensual de soporte',
...
const FASES = [
  ...
  },
  {
    ...
    titulo: 'Revisión, aprobación y órdenes de compra',
    color: '#a78bfa',
    colorAlpha: 'rgba(167,139,250,.10)',
    colorBorder: 'rgba(167,139,250,.28)',
    desc: 'Construimos el flujo de decisión completo, desde la bandeja de revisión hasta las órdenes partidas por proveedor.',
    hitos: [
      ...
      'Generación automática de Órdenes de Compra agrupadas por proveedor, con sus estados',
    ],
...
const FUERA = [
  {
    ...
    desc: 'La línea dedicada con formulario estructurado queda para una fase posterior. Requiere verificación de negocio ante Meta, que no es inmediata, y genera tarifas por conversación facturadas aparte.',
...
const FASE2 = [
  'Autoservicio de proveedores con carga de Cámara de Comercio, RUT y certificados',
  'Autoservicio de obras y etiquetas administrado directamente por Mizar',
  'Reportes ejecutivos por periodo y tipo de gasto, con vista de flujo de trabajo',
  'Notificaciones automáticas cuando algo espera una aprobación',
  'Umbral por monto que exija un segundo aprobador, si se define la regla',
];
...
const TERMINOS: { titulo: string; desc: string; icon: React.ElementType }[] = [
  ...
  },
  {
    ...
    desc: 'Dos cuotas iguales de $2.000.000 COP: la primera al iniciar el proyecto y la segunda contra la entrega de la plataforma en producción.',
    icon: FileText,
  },
  {
      ...
      <main className="max-w-4xl mx-auto px-5 sm:px-8 md:px-10 py-20 space-y-24">
          ...
          <div className="rounded-2xl p-5 sm:p-6 mb-8" style={{ background: 'rgba(255,255,255,.03)', border: '1px solid rgba(255,255,255,.07)' }}>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-2.5">
              {[
                ...
                { n: '4', t: 'Orden de compra',  s: 'Una por cada proveedor',          c: '#f59e0b',  bg: 'rgba(245,158,11,.08)',  bd: 'rgba(245,158,11,.22)' },
        ...
        <section id="alcance" ref={s5.ref as React.RefObject<HTMLElement>}
          ...
          <div className="rounded-2xl p-5 sm:p-6" style={{ background: 'rgba(0,191,165,.05)', border: '1px solid rgba(0,191,165,.20)' }}>
            ...
            <p className="font-lato text-white/55 text-[16px] leading-relaxed mb-5">
              Nada de lo entregado se descarta ni se rehace al ampliar el alcance. Además del canal de WhatsApp, estas ampliaciones se cotizan por separado cuando Mizar decida abordarlas:
            </p>
        ...
        <section id="inversion" ref={s6.ref as React.RefObject<HTMLElement>}
          ...
          <div className="rounded-xl p-5 sm:p-6 mb-6"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {[
                { pct: '50%', momento: 'Al iniciar el proyecto', desc: 'Con la aceptación de la propuesta y la firma del contrato arranca el desarrollo, contando desde ahí las seis semanas del cronograma.', valor: '$2.000.000' },
                { pct: '50%', momento: 'Al entregar la herramienta', desc: 'El saldo se paga contra la entrega de la plataforma en producción, con el equipo capacitado y operando.', valor: '$2.000.000' },
              ].map((pago, i) => (
